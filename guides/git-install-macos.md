...
can install these by typing the following in the terminal:
```bash
...
If you plan to interact with GitHub only via Visual Studio Code, you can skip setting up
an SSH key.

In order to seamlessly access your remote repositories on GitHub in the terminal, 
you *may* need to create an SSH key on your local computer and 
...
If you want to clone an existing repository hosted on GitHub (for example the [course 
repository](https://github.com/richardfoltyn/FIE463-V26)), proceed as follows:
```bash
...
1.  Create a new repository on GitHub, either by clicking 
...
- Alternatively, if you are accessing GitHub via VS Code, you'll be redirected to the browser where you can log in to GitHub.