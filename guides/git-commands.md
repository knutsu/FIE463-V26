...
Shows line-by-line differences for each new or updated file.
...
```bash
git remote add origin https://github.com/richardfoltyn/FIE463-V26.git
...
```bash
git remote add origin git@github.com:richardfoltyn/FIE463-V26.git
git push -u origin main             # Push the main branch to the remote
```