...
1.  Download VS Code for your platform (Windows / macOS / Linux) from the [project website](https://code.visualstudio.com/download).
...
- VS Code comes with numerous useful Python extensions. You'll be 
  asked to install them when you open Python files or Jupyter notebooks for the first time.